...
![This is the prompt that first appears in the console when you run the program. Lets assume I want to start at Joshua Tree:](National%20Park%20Router%208d4f5bde6b8a47928f3345ef1a4cacc2/Screen_Shot_2022-05-08_at_10.35.51_PM.png)

This is the prompt that first appears in the console when you run the program. Lets assume I want to start at Joshua Tree:

![Screen Shot 2022-05-08 at 10.36.28 PM.png](National%20Park%20Router%208d4f5bde6b8a47928f3345ef1a4cacc2/Screen_Shot_2022-05-08_at_10.36.28_PM.png)
